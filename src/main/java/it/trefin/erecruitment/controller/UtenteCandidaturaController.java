...
public class UtenteCandidaturaController {
	...
	@DeleteMapping("/elimina/{idUtente}/{idCandidatura}")
	public Response<List<UtenteCandidaturaDto>, Status> eliminaUtenteCandidatura(@PathVariable long idUtente,@PathVariable long idCandidatura) {
		return ucService.eliminaUtenteCandidatura(idUtente,idCandidatura);
	}
