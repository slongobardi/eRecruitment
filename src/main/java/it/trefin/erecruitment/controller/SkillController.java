...
public class SkillController {
	...
	@GetMapping("/visualizzaSkillUtente/{id}")
	public Response<List<SkillDto>, Status> visualizzaSkillUtente(@PathVariable long id){
		return sService.visualizzaSkillUtente(id);
	}
